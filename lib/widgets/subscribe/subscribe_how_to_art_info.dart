            ...
            children: [
              ...
              Table(
                  ...
                  children: const [
                    ...
                    TableRow(
                        children: [Text('Open journey'), Text('open-journey')]),
                    TableRow(children: [Text('stable diffusion'), Text('sd')]),
                    TableRow(children: [Text('DALL-E'), Text('dall-e')]),
                    TableRow(
                        children: [Text('Epic Realism'), Text('epic-realism')]),
                    TableRow(children: [Text('funko'), Text('funko')]),
                    TableRow(children: [Text('majicmix'), Text('majicmix')]),
                  ]),
              const SizedBox(
                height: 20,
              ),
              ...
              TextButton(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: APP_MUTED_COLOR, fontSize: 10),
                ),
              )
            ],
          ),
