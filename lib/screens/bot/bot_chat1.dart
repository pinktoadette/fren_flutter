...
//   }
//
//   Future<void> _saveMessage(message, otherUserId) async {
//     // save as types.User
//     await _messagesApi.saveChat(message, otherUserId);
//
//   }
//
...
//     _saveMessage(textMessage, chatController.chatBot.id);
...
//       _addMessage(textMessage);
//       _saveMessage(textMessage, chatController.chatUser.id);
//     });
//   }
//
